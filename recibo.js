...
if (item==1){
  ...
  let contenido = document.getElementById("recibo1").innerHTML;
  let contenidoOriginal = document.body.innerHTML;
...
if (item==2){
  ...
  let contenido = document.getElementById("recibo2").innerHTML;
  let contenidoOriginal = document.body.innerHTML;
...
if (item==3){
  ...
  let contenido = document.getElementById("recibo3").innerHTML;
  let contenidoOriginal = document.body.innerHTML;
