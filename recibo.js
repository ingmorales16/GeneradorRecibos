...
function imprimirRecibo() {
  if (item==0){
    ...
    recibo.classList.remove("impreso");
  }
  ...
  if (item==1){
    ...
    // Agregar clase "impreso" para aplicar estilos de impresión
    const recibo = document.getElementById("recibo1");
    recibo.classList.add("impreso");
  ...
  if (item==2){
    ...
    // Agregar clase "impreso" para aplicar estilos de impresión
    const recibo = document.getElementById("recibo2");
    recibo.classList.add("impreso");
  ...
  if (item==3){
    ...
    // Agregar clase "impreso" para aplicar estilos de impresión
    const recibo = document.getElementById("recibo3");
    recibo.classList.add("impreso");
