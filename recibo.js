...
itemBtn.addEventListener("click", agregaritem);
...
function imprimirRecibo() {
  ...
  printJS({
    ...
    onPrintComplete: function() {
      // código a ejecutar después de que se complete la impresión
      aumentarContador();
    },
    onError: function() {
      // código a ejecutar si ocurre un error durante la impresión
      console.log('Ocurrió un error durante la impresión');
    },
  });
...
function agregaritem(){
  ...
  if (item<4){
    ...
    if (item==1){
      ...
      alert("Se agrega la segunda fila de items a la tabla");
     }
     ...
     let tabla2 =
      ...
      alert("Se agrega la tercera fila de items a la tabla");      
     }
     ...
     if (item==3){
      ...
      let tabla3 =
       ...
       alert("Se agrega la cuarta fila de items a la tabla");       
      }
